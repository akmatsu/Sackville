...
test('division codes are unique per department but not globally unique', function () {
    ...
    $division = Division::factory()->create(['department_code' => $departmentTwo->code, 'code' => '117']);
