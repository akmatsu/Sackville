...
class Responsibility extends Model
{
    ...
    /**
     * Whether this responsibility's scope covers the given Metronet circuit.
     *
     * Kept in sync with {@see TdxMetronetCircuit::scopeVisibleTo()}, which
     * applies the same rules at the SQL level for query filtering.
     */
    public function matchesMetronetCircuit(TdxMetronetCircuit $circuit): bool
    {
        return match ($this->scope_type) {
            ResponsibilityScopeType::Division => $this->responsible_division_id !== null
                && $this->responsible_division_id === $circuit->responsible_division_id,
