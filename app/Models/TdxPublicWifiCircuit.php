...
class TdxPublicWifiCircuit extends Model
{
    ...
    /**
     * @return HasMany<PublicWifiCircuitReview, $this>
     */
    public function reviews(): HasMany
    {
        return $this->hasMany(PublicWifiCircuitReview::class);
    }

    /**
     * Scope circuits to those the user can act on, based on their
     * responsibility scopes. A verbatim copy of
     * {@see TdxAsset::scopeVisibleTo()}: this table carries the same
     * `assigned_department_code` / `responsible_division_id` /
     ...
     * {@see Responsibility::matchesPublicWifiCircuit()}, which applies the
